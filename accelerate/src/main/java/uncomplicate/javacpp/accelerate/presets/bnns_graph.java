 ...
 */
@Properties(inherit = javacpp.class, global = "uncomplicate.javacpp.accelerate.global.bnns_graph", value = {
        @Platform(value = "macosx-arm64",
                  include = {"bnns_constants.h", "bnns_structures.h", "bnns_graph.h"},
